...
* T7: Phase2 tilted tracker (v6.1.4) w/ phase 2 pixel (v4.6.0) (same as T6 but TBPX services routed over TBPX in IT)
* T8: Phase2 tilted tracker (v6.1.4) w/ phase 2 pixel (v4.6.1) (same as T6 but TBPX services directly routed towards TFPX in IT)
