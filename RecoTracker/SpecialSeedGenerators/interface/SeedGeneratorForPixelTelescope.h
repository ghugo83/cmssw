#ifndef SpecialSeedGenerators_SeedGeneratorForPixelTelescope_h
#define SpecialSeedGenerators_SeedGeneratorForPixelTelescope_h
/*
...
class SeedGeneratorForPixelTelescope{
    public:
    SeedGeneratorForPixelTelescope(const MagneticField* mf,
    ...
    ~SeedGeneratorForPixelTelescope(){};
