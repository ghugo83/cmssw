#ifndef PixelTelescopeSpecialSeedGenerator_H
#define PixelTelescopeSpecialSeedGenerator_H
...
class PixelTelescopeSpecialSeedGenerator : public edm::stream::EDProducer<>
{
 public:
  typedef TrajectoryStateOnSurface TSOS;
  

  PixelTelescopeSpecialSeedGenerator(const edm::ParameterSet& conf);

  ~PixelTelescopeSpecialSeedGenerator() override;//{};
 ...
 private:
  ...
  SeedGeneratorForPixelTelescope* theSeedBuilder; 
