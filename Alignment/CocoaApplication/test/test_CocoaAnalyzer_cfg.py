...
# Ideal geometry
process.load('Geometry.CMSCommonData.cmsIdealGeometryCOCOAXML_cfi')
...
#                               "DetectorDescription/DDCMS/data/vacuum.xml",
#                               "Alignment/CocoaApplication/test/table2DWithMirror.xml"),
#    rootNodeName = cms.string('table2DWithMirror:MotherOfAllBoxes')
#)
