...
//if (!myDet->params().empty()) {
if (myDet->shape_dd4hep() == cms::DDSolidShape::ddbox || myDet->shape_dd4hep() == cms::DDSolidShape::ddtrap || myDet->shape_dd4hep() == cms::DDSolidShape::ddtubs) {
