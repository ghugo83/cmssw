...
void CmsTrackerITRingBuilder::buildComponent(DDFilteredView& fv, GeometricDet* g, std::string s){
...
void CmsTrackerITRingBuilder::sortNS(DDFilteredView& fv, GeometricDet* det){
