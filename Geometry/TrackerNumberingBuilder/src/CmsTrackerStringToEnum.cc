...
CmsTrackerStringToEnum::Impl::Impl(){
  ...
  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2TiltedBarrelLayer",GeometricDet::PixelPhase2TiltedBarrelLayer));
  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2TiltedBarrelLadder",GeometricDet::ladder));
  _map.insert(std::pair<std::string, GeometricDet::GeometricEnumType>("PixelPhase2TiltedBarrelRing",GeometricDet::panel));
  ...
  _reverseMap.insert(std::pair<GeometricDet::GeometricEnumType, std::string>(GeometricDet::PixelPhase2TiltedBarrelLayer,"PixelPhase2TiltedBarrelLayer"));
